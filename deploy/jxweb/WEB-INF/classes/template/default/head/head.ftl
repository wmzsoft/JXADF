...
<#if ((parameters.headtype!'')=="TOPMENU" || (parameters.headtype!'')=="SKIN")>
...
<#--加载jQuery相关的资源-->
    ...
    <script type='text/javascript' src='${base}/javascript/jquery-ui-1.10.3/ui/jquery-ui.js'></script>
...
<#elseif ((parameters.headtype!'')=="SKIN")>
    <script type='text/javascript' src='${base}/javascript/jxkj/jxmenu-v-icon.js'></script>
    <script type='text/javascript' src='${base}/javascript/jxkj/skinswitch.js'></script>
<#else>
...
<#-- 加载datatable -->
    ...
    <link rel='stylesheet' type='text/css'
          href='${base}/javascript/dataTables1.9.4/css/jquery.dataTables_themeroller.css'/>
    <script type='text/javascript'
            src='${base}/javascript/dataTables1.9.4/plugins/scroller/js/dataTables.scroller.js'></script>
    <link rel='stylesheet' type='text/css'
          href='${base}/javascript/dataTables1.9.4/plugins/scroller/css/dataTables.scroller.css'/>
...
<#--加载jQuery.i18n.properties插件-->
    ...
    <script type="text/javascript" src="${base}/javascript/jquery-cookie/jquery.cookie.js"></script>
<#--加载自定义js相关的资源-->
