...
(function ($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _rearrange: function (event, i, a, hardRefresh) {
            ...
            if(a){
                a[0].appendChild(placeholder);
            }else{
                item.parentNode.insertBefore(placeholder, (item.className == "empty" || this.direction === "down" ? item : item.nextSibling))
            }
            //a ? a[0].appendChild(placeholder) : item.parentNode.insertBefore(placeholder, (this.direction === "down" ? item : item.nextSibling));
