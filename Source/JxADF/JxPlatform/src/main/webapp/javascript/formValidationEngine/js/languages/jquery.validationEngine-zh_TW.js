        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "orgCodeValiDation":{
                    ...
                    "alertText": "*請輸入正確的組織機構代碼，示例:12345678-1"
                },
                "businessLicenseValiDation":{
                    "regex":/^\d{16}$|^\d{18}$/,
                    "alertText": "*請輸入正確營業執照號，只能是16或18位數字"
                },
                "loanCardNumberValiDation":{
                    "regex":/^\d{16}$/,
                    "alertText": "*請輸入正確的貸款卡號，只能是16位數字"
                },
                "orgCreditCodeValiDation":{
                    "regex":/^[a-zA-z-0-9]{18}$/,
                    "alertText": "*請輸入正確的機構信用代碼，長度18，只能包含a-z,A-Z,0-9的字符串"
                },
                "chinaId":{
                    /**
